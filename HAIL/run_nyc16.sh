...
signature_para="_alpha${alpha}-beta${beta}-gamma${gamma}-mp${mask_prob}-sw${prop_sliding_window}-mlp${masked_lm_prob}-df${dupe_factor}-mpps${max_predictions_per_seq}-msl${max_seq_length}"
